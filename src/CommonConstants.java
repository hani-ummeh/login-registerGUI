...
public class CommonConstants {
    ...
    // color configs
    public static final Color PRIMARY_COLOR = new Color(84, 114, 166);
    public static final Color SECONDARY_COLOR = new Color(228, 118, 198);
    public static final Color BUTTON_COLOR = new Color(84, 11, 139);
